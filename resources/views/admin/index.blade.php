            ...
            <div class="card-body">
              <div class="clearfix">
                ...
                <div class="float-right">
                  <p class="card-text text-dark">Tổng User</p>
                  <h4 class="bold-text">{{$sumUser}}</h4>
                </div>
              </div>
              <p class="text-muted">
          ...
          <div class="card card-statistics">
            <div class="card-body">
              <div class="clearfix">
                ...
                <div class="float-right">
                  <p class="card-text text-dark">Tổng Order</p>
                  <h4 class="bold-text">{{$sumOrder}}</h4>
                </div>
              </div>
             <!--  <p class="text-muted">
              ...
              <div class="clearfix">
                <div class="float-left">
                  <h4 class="text-success">
                    <i class="fas fa-hand-holding-usd highlight-icon" aria-hidden="true"></i>
                  </h4>
                </div>
                <div class="float-right">
                  <p class="card-text text-dark">Sản Phẩm</p>
                  <h4 class="bold-text">{{$sumProduct}}</h4>
                </div>
              </div>
              <!-- <p class="text-muted">
              ...
              <div class="clearfix">
                <div class="float-left">
                  <h4 class="text-primary">
                    <i class="far fa-comments highlight-icon" aria-hidden="true"></i>
                  </h4>
                </div>
                <div class="float-right">
                  <p class="card-text text-dark">Bình luận</p>
                  <h4 class="bold-text">{{$sumComment}}</h4>
                </div>
              </div>
              <!-- <p class="text-muted">
