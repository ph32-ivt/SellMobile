...
class ProductTableSeeder extends Seeder
{
    ...
    {        
        DB::table('products')->insert([
            ...
            ['name'=>'iPhone Xs Max 256GB','pro_slug'=>'iphone-xs-max-256gb-white','description'=>'Sau 1 năm mong chờ, chiếc smartphone cao cấp nhất của Apple đã chính thức ra mắt mang tên iPhone Xs Max. Máy các trang bị các tính năng cao cấp nhất từ chip A12 Bionic, dàn loa đa chiều cho tới camera kép tích hợp trí tuệ nhân tạo.','image'=>'iphone-xs-max-256gb-white.jpg','status'=>1,'pro_hot'=>2,'category_id'=>1,'created_at' => now(),'updated_at' => now()],
            //sam sung 
            ...
            ['name'=>'OPPO R17 Pro','pro_slug'=>'oppo-r17-pro-14','description'=>'Samsung Galaxy S10+ (512GB) - phiên bản kỷ niệm 10 năm chiếc Galaxy S đầu tiên ra mắt, là một chiếc smartphone hội tủ đủ các yếu tố mà bạn cần ở một chiếc máy cao cấp trong năm 2019.','image'=>'oppo-r17-pro-14.jpg','status'=>1,'pro_hot'=>2,'category_id'=>3,'created_at' => now(),'updated_at' => now()],
            //xiaomi
            ...
            ['name'=>'Xiaomi Redmi Note 7 64GB','pro_slug'=>'xiaomi-redmi-note-7','description'=>'Xiaomi Redmi Note 7 là chiếc smartphone giá rẻ mới được giới thiệu vào đầu năm 2019 với nhiều trang bị đáng giá như thiết kế notch giọt nước hay camera lên tới 48 MP','image'=>'xiaomi-redmi-note-7.jpg','status'=>1,'pro_hot'=>1,'category_id'=>4,'created_at' => now(),'updated_at' => now()],
